...
public final class AppConstants {
    ...
    public static final String GREETING_GOOD_MORNING = "Hayirli tong ";
    public static final String GREETING_GOOD_AFTERNOON = "Hayrli kun ";
    public static final String GREETING_GOOD_EVENING = "Hayirli tun ";
